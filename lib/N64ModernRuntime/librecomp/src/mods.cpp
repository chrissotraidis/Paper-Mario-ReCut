...
#if defined(N64MODERN_NO_DYNAMIC_CODE)
// Mobile release builds neither allocate nor execute generated code. These
// inert shim definitions satisfy ModContext's ownership types while every
// live-recompiler handle above reports a clean unsupported result.
